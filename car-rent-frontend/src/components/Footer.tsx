        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">CarBorrow</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Your trusted car rental service providing premium vehicles 
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-primary-400 transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.987-5.367 11.987-11.988C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.316-1.357C4.264 14.795 3.776 13.644 3.776 12.348c0-1.297.488-2.449 1.357-3.316.868-.867 2.019-1.357 3.316-1.357 1.297 0 2.448.49 3.316 1.357.867.867 1.357 2.019 1.357 3.316 0 1.296-.49 2.447-1.357 3.314-.868.867-2.019 1.357-3.316 1.357z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/vehicles" className="text-gray-400 hover:text-primary-400 transition-colors">
                  Vehicles
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} CarBorrow. All rights reserved.
            </p>
